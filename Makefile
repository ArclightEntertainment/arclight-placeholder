...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		data/arraycollection.h data/DatabaseInterface.cpp \
		interface/main.cpp \
		interface/Animal.cpp \
		interface/AnimalManager.cpp \
		interface/MainWindow.cpp \
