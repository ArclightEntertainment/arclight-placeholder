...
//Constructor and population functions
    ...
    void populateProfile(int a, bool hasUnderTwelve, bool hasPets, int ownExp, int budget, int timeAvail, FiveScale lOfMobility, FiveScale lOfEnergy, FiveScale lOfPatience, FiveScale prevExp, FiveScale physAffect);
