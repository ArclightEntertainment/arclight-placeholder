...
void ClientManager::populateClientProfile(int index, int a, bool hasUnderTwelve, bool hasPet, int ownExp, int budget, int timeAvail, FiveScale lOfMobility, FiveScale lOfPatience, FiveScale prevExp, FiveScale physAffect)
{
    clientCollection[index].populateProfile(a, hasUnderTwelve, hasPet, ownExp, budget, timeAvail, lOfMobility, lOfPatience, prevExp, physAffect);
}
