...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(10, 9, 391, 241));
        ...
        gridLayout->addWidget(inputButton, 1, 3, 1, 1);

        horizontalSpacer_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_3, 1, 4, 1, 1);

        viewButton = new QPushButton(gridLayoutWidget);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        inputButton->setText(QApplication::translate("MainWindow", "Input New Pet", Q_NULLPTR));
        viewButton->setText(QApplication::translate("MainWindow", "View All Pets", Q_NULLPTR));
    } // retranslateUi
